// 国内手机号校验
export const ChinaMobileValidator = (rule: any, value: string) => {
  if (
    value && value.match(/^1\d{10}$/)
  ) {
...
// 手机号、电话号码校验
export const TelephoneValidator = async (rule: any, value: string) => {
...
export const IdCardValidator = async (rule: any, code: string) => {
