...
var ChaosUpload = function ChaosUpload(_ref) {
  ...
  var beforeUpload = (0, _utils.fileValidatorFactory)(rest); // 上传前校验
  ...
  var uploadNode = children ? children : rest.listType == 'picture-card' ? _react.default.createElement(_react.Fragment, null, _react.default.createElement(_reactIcons.IconContext.Provider, {
    value: {
      className: 'chaos-upload-picture-icon'
    }
  }, _react.default.createElement(_ai.AiOutlinePlus, null)), _react.default.createElement("div", {
    className: "ant-upload-text"
  }, "\u4E0A\u4F20\u56FE\u7247")) : _react.default.createElement(_button.default, {
    type: "default"
  }, _react.default.createElement(_reactIcons.IconContext.Provider, {
    value: {
      className: 'chaos-upload-icon'
    }
  }, loading ? _react.default.createElement(_ai.AiOutlineLoading, null) : _react.default.createElement(_ai.AiOutlineUpload, null)), "\u6587\u4EF6\u4E0A\u4F20");
  return _react.default.createElement(_upload.default, Object.assign({
    disabled: max && fileList && fileList.length >= max ? true : false
  }, rest, {
    name: formItemPropsContext.name,
    fileList: fileList,
    accept: (0, _utils.convetAccept)(rest.accept),
...
var _default = (0, _FormItem.WrapFormItem)(ChaosUpload, {
