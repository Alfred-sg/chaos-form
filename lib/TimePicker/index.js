...
var ChaosTimePicker = function ChaosTimePicker(props) {
  return _react.default.createElement(_antd.TimePicker, Object.assign({}, props));
};

var ChaosRangePicker = function ChaosRangePicker(props) {
  return _react.default.createElement(_antd.TimePicker.RangePicker, Object.assign({}, props));
};
