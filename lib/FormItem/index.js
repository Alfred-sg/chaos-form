...
var WrapFormItem = function WrapFormItem(Field, options) {
  var FormItemWrapper = function FormItemWrapper(props) {
    ...
    var formItemProps = (0, _utils.extract)(rest, isDetail ? detailFormItemPropNames : formItemPropNames);
    ...
    return _react.default.createElement(FormItem, Object.assign({}, finalFormItemProps), isDetail && DetailComponent ? // @ts-ignore
