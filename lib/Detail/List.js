...
var List = function List(_ref) {
  ...
  return _react.default.createElement("div", {
    ...
    return _react.default.createElement("div", {
      ...
      key: index
    }, renderItemDetail ? renderItemDetail(item, index) : _react.default.createElement("div", {
      className: "chaos-form-detail-row",
      key: index
    }, _react.Children.map( // @ts-ignore
    children, function (child) {
      var props = child.props;
      return (0, _react.cloneElement)(child, _objectSpread(_objectSpread({}, props), {}, {
